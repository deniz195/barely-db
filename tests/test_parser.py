...
def test_parser_basic(CBUIDParser):
    ...
    _test_parser_mode(
        CBUIDParser(ignore_unknown=False, mode='all'), ['SL0293', 'SL0333', 'DP0241', 'SL0333', 'DP0241']
    )
    ...
    _test_parser_restriction(
        CBUIDParser(ignore_unknown=True, mode='all', allowed_types=['SL']), ['SL0293', 'SL0333', 'SL0333',]
    )
